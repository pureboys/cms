...
function adver(type){
    ...
    switch (type){
        ...
        case 2:
            ...
            up.innerHTML = "<input type=\"button\" value=\"上传头部广告\" onclick=\"centerWindow('../config/upfile.php?type=adver&size=690*80','upfile','400','100')\"/>";
            fm.adv.value = 2;
            break;
        case 3:
            thumbnail.style.display = 'block';
            up.innerHTML = "<input type=\"button\" value=\"上传侧栏广告\" onclick=\"centerWindow('../config/upfile.php?type=adver&size=270*200','upfile','400','100')\"/>";
            fm.adv.value = 3;
            break;
    }
}
