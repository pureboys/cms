...
{if $update}
    <form action="?action=update" name="content" method="post">
        <table class="content">
            ...
            <tr>
                <td>文档标题： <input type="text" name="title" class="text" value="{$titlec}"/><span class="red">[必填]</span>(* 标题2-50之间)</td>
            </tr>
            <tr>
                <td>栏　　目： <select name="nav" id="">
                        <option value="" style="padding: 0">请选择一个栏目类别</option>
            ...
            <tr>
                <td>关 键 字： <input type="text" name="keyword" class="text" value="{$keyword}"/>(*每个关键字用','隔开,总长不超过30位)</td>
            </tr>
            <tr>
                <td>缩 略 图： <input type="text" value="{$thumbnail}" name="thumbnail" class="text" readonly/> <input type="button"
                                                                                              value="上传缩略图"
                                                                                              onclick="centerWindow('../templates/upfile.html','upfile','400','100')"/>
            ...
            <tr>
                <td><span class="middle">内容摘要：</span> <textarea name="info" id="" cols="" rows="">{$info}</textarea><span
                            class="middle">(*内容摘要200以内)</span></td>
            </tr>
            <tr class="ckeditor">
