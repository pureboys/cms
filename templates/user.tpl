...
{if $add}
    <form action="" method="post" name="update">
        <table cellspacing="0" class="user">
            ...
            <tr>
                <td>密　　码: <input type="password" class="text" name="pass"/><span class="red">[必填]</span>(*密码不得小于6位)</td>
            </tr>
            <tr>
                <td>密码确认: <input type="password" class="text" name="notpass"/><span class="red">[必填]</span>(*和密码一致)</td>
            </tr>
            <tr>
                <td>电子邮件: <input type="text" class="text" name="email"/><span class="red">[必填]</span>(*每个电子邮件只能注册一个ID)
                </td>
            </tr>
            <tr>
                <td>选择头像: <select name="face" id="" onchange="sface();">
            ...
            <tr>
                <td><img name="faceimg" src="/images/01.gif" alt="01.gif" class="face"/></td>
            </tr>
            <tr>
                <td>安全问题: <select name="question" id="">
            ...
            <tr>
                <td>问题答案: <input type="text" class="text" name="answer"/></td>
            </tr>
            <tr>
                <td>设置权限: <input type="radio" name="state" value="0"/>被封杀会员
            ...
            <tr>
                <td><input type="submit" name="send" value="注册会员" class="submit" onclick="return checkReg();"/></td>
            </tr>
        </table>
    </form>
{/if}
...
{if $update}
    <form action="" method="post" name="update">
        ...
        <table cellspacing="0" class="user">
            ...
            <tr>
                <td>密　　码: <input type="password" class="text" name="pass"/>(留空则不修改)</td>
            </tr>
            <tr>
                <td>电子邮件: <input type="text" class="text" name="email" value="{$email}"/><span class="red">[必填]</span>(*每个电子邮件只能注册一个ID)
                </td>
            </tr>
            <tr>
                <td>选择头像: <select name="face" id="" onchange="sface();">
            ...
            <tr>
                <td><img name="faceimg" src="/images/{$facesrc}" alt="01.gif" class="face"/></td>
            </tr>
            <tr>
                <td>安全问题: <select name="question" id="">
                        <option value="">没有任何安全问题</option>
            ...
            <tr>
                <td>问题答案: <input type="text" class="text" name="answer" value="{$answer}"/></td>
            </tr>
            <tr>
                <td>设置权限: {$state}
                </td>
            ...
            <tr>
                <td><input type="submit" name="send" value="修改会员" class="submit" onclick="return checkUpdate();"/> [<a
                            href="{$prev_url}">返回上一层</a>]
                </td>
            </tr>
        </table>
    </form>
